...
```{r}
dat %>% group_by(other_functionality) %>% 
  summarise(n = length(other_functionality), pc = n/84)
```
# Figures
...
functionality <- dat %>% 
  ...
  pivot_longer(cols = everything(), names_to = "Functionality", values_to = "status") %>% 
  group_by(Functionality, status) %>% 
...
functionality <- functionality %>%
  mutate(potency_ass = recode_factor(Functionality,
                                     other_functionality = "Other functionality",
                                     C = "Chondrogenesis",
                                     A = "Adipogenesis",
                                     O = "Osteogenesis"))

functionality$potency_ass <- fct_relevel(functionality$potency_ass,
                                         "Other functionality",
                                         "Chondrogenesis",
                                         "Adipogenesis",
                                         "Osteogenesis")
...
fig8 <- functionality %>% 
  ggplot() +
  geom_bar(aes(x = potency_ass, y = n, fill = status),
