...
Fit on single 8.5" × 11" or A4 paper
Preferably at:
1 column - 3.5 inches
1.5 columns - 5.0 inches
2 columns = 7.3 inches
...
ggsave("figs/fig_x3_cd_refs_bar.wmf", 
       plot = cd_refs_bar, 
       device = "wmf",
       width = fig_w, 
       height = fig_w,
...
cd_values_point_isct <- cd_dat_summary_values %>% 
  ...
  theme(axis.title.y = element_blank(),
        ...
        legend.position = "none",
        plot.title = element_text(hjust = 0, size = 4))
ggsave("figs/fig_x4_cd_values_isct.wmf", 
...
cd_values_point_other <- cd_dat_summary_values %>% 
  ...
  theme(axis.title.y = element_blank(),
        ...
        legend.position = "none",
        plot.title = element_text(hjust = 0, size = 4))
ggsave("figs/fig_x5_cd_values_isct.wmf", 
